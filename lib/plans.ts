...
export const PLAN_DEFINITIONS: PlanDefinition[] = [
  {
    ...
    maxUsers: 5,
    highlights: ["Jusqu'à 5 comptes", "Comptabilité, tiers et copilote IA", "Support par email"],
    priceMonthlyUsd: 49,
  },
  {
    id: "PRO",
    name: "Pro",
    tagline: "Pour une entreprise en croissance",
    maxUsers: 20,
    highlights: ["Jusqu'à 20 comptes", "Immobilisations & rapprochement bancaire", "Support prioritaire"],
    priceMonthlyUsd: 149,
  },
  {
    id: "ENTERPRISE",
    name: "Enterprise",
    tagline: "Pour un groupe multi-entités",
    maxUsers: Number.POSITIVE_INFINITY,
    highlights: ["Comptes illimités", "Consolidation multi-entreprises", "Accompagnement dédié"],
